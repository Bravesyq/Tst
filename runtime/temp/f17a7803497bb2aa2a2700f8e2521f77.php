<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\PHPTutorial\WWW\Tst\public/../application/admin\view\staff\index.html";i:1587002024;}*/ ?>
<!DOCTYPE html>
        ...
        <tbody>
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
                ...
                <tr>
                    ...
                    <td> <input type="text" value="<?php echo $value['name']; ?>" style="width:60px;" onblur="t_ajax_name(this,<?php echo $value['id']; ?>)"> </td>
                    <td> <input type="text" value="<?php echo $value['lxfs']; ?>" style="width:100px;" onblur="t_ajax_lxfs(this,<?php echo $value['id']; ?>)"></td>
                    <td> <input type="text" value="<?php echo $value['address']; ?>" style="width:180px;" onblur="t_ajax_address(this,<?php echo $value['id']; ?>)"></td>
                    <td>
